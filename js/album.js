...
$(document).ready(function(){
  ...
  $('.gallery_preview').fadeOut(500, function(){
    ...
    $('.gallery_preload_area img').imgpreload(function(){
      $('.gallery_preview').html('<a class="overlaylink" href="' + first_photo_fullsize + '" title="' + first_photo_caption + '" style="background-image:url(' + first_photo_preview + ');"><img src="'+ first_photo_preview+'"/></a>');
      $('.gallery_caption').html('<p><a class="overlaylink" href="' + first_photo_fullsize + '" title="' + first_photo_caption + '">view larger</a></p><p>' + first_photo_caption + '</p>');
      $('.gallery_preview').fadeIn(500);
      $('.gallery_caption').slideDown(500);
